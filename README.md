...
* [Koreader](https://github.com/koreader/koreader) ⭐ 29,335 | 🐛 1,326 | 🌐 Lua | 📅 2026-08-29 - An ebook reader app running on kindle.
...
* [Calibre](https://github.com/kovidgoyal/calibre) ⭐ 25,753 | 🐛 6 | 🌐 Python | 📅 2026-08-29 - A famous ebook manager.
* [kindle2notion](https://github.com/paperboi/kindle2notion) ⭐ 964 | 🐛 22 | 🌐 Python | 📅 2023-12-23 - A program to copy all your Kindle highlights and notes to a page in Notion.
...
* [marginalia](https://github.com/VforVitorio/marginalia) ⭐ 3 | 🐛 14 | 🌐 Python | 📅 2026-08-24 - Turn handwritten Kindle Scribe notebooks (PDF) into Obsidian Markdown via local (Qwen3-VL/Ollama) or cloud OCR, with a side-by-side review step. Mirrors your Scribe folder structure.
...
* [Kindle Comic Converter](https://github.com/ciromattia/kcc) ⭐ 5,572 | 🐛 55 | 🌐 Python | 📅 2026-08-28 ([Official](https://kcc.iosphe.re/)) - A Python app to convert comic files to e-books.
* [KindleEar](https://github.com/cdhigh/KindleEar) ⭐ 2,867 | 🐛 2 | 🌐 Python | 📅 2026-08-14 - An app to aggergate RSS for generating periodical mobi/epub file and send it automatically.
...
* [KindleUnpack](https://github.com/kevinhendricks/KindleUnpack) ⭐ 1,097 | 🐛 5 | 🌐 Python | 📅 2026-05-21 - An app to unpack Amazon / Kindlegen generated ebooks.
* [Kindle Clippings Cleaner](https://github.com/flawnn/KindleClippingsCleaner) ⭐ 5 | 🐛 1 | 🌐 JavaScript | 📅 2022-08-06 - Remove duplicated entries from your clippings.txt for usage in third-party services like Readwise
...
* [Kindle Side Card](https://github.com/perduewu-ops/kindle-side-card) ⭐ 38 | 🐛 1 | 🌐 Python | 📅 2026-05-25 - A local-first KUAL side display for dashboards and desktop status.
